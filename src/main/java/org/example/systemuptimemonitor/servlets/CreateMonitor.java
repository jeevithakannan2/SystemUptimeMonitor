...
public class CreateMonitor extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (name == null || name.isEmpty() || targetUrl == null || targetUrl.isEmpty() || expected_status_codes == null || expected_status_codes.isEmpty() || check_interval == null || check_interval.isEmpty() || enabled == null || enabled.isEmpty() || failureCount == null || failureCount.isEmpty()) {
        ...
        int failureCount1 = Integer.parseInt(req.getParameter("failure_count"));
        ...
        Monitor monitor = new Monitor(name, targetUrl, checkInterval, user.getOrganization(), user.getId(), System.currentTimeMillis(), failureCount1, enabled1);
