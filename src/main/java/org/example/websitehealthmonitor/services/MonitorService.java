...
import org.example.websitehealthmonitor.dao.MonitorAuditDao;
import org.example.websitehealthmonitor.dao.MonitorDao;
import org.example.websitehealthmonitor.dao.StatusCodeDao;
import org.example.websitehealthmonitor.exceptions.MissingMonitorException;
import org.example.websitehealthmonitor.exceptions.MonitorAlreadyExistsException;
...
import org.example.websitehealthmonitor.util.MonitorExecutor;
...
public class MonitorService {
    ...
    public ArrayList<org.example.websitehealthmonitor.model.MonitorAudit> getMonitorHistory(int monitorId, String organization) throws SQLException {
        try (Connection connection = DBManager.getConnection(organization)) {
